...
function Landing() {
  return (
    <div className={styles.header} id='/'>
      <div className="bg-slate-500/40 w-full h-full flex justify-center items-center">
        <div className='text-current text-center text-[5.5rem]'>
          ...
          <Link className={`${styles.btn} ${styles.btn_lg} text-white bg-[#ff214f] border-[#ff214f]`} href="#gallery">View
            Our gallary</Link>
        </div>
      </div>
    </div>
